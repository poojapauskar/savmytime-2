...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 style="font-size:20px;text-align:center;margin-top:1%;font-family: Lato-Regular;" class="page-header">Software development
        ...
        <div class="row" style="margin-top:-1%">
            <div class="col-md-3 portfolio-item" style="width:50%;height:30%">
                <a href="page2.html">
                    <div class="zoom">
                    <img class="img-responsive" src="mobile.png" alt="">
                    </div>
...
All 3rd party charges would be over and above the development fees mentioned above.</p>
