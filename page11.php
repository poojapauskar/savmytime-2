...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 style="font-size:20px;text-align:center;margin-top:1%;font-family: Lato-Regular;" class="page-header">DIGITAL MARKETING
        ...
        <div class="row" style="margin-top:-1%">
            <div class="col-md-3 portfolio-item" style="width:50%;height:30%">
                <a href="page2.html">
                    <div class="zoom">
                    <img class="img-responsive" src="digimark.png" alt="">
                    </div>

                    <h1 style="font-size:15px;float:left;color:black;font-family: Lato-Regular;">We recommend the following combination of tools depending on the type and size of your business.<br><br>

                    <strong style="font-family: Lato-Light;color:484848">For B2B we recommend:</strong><br>

                    STP analysis<br>

Linkedin Promotion<br>
...
Seasonal Advertisements<br><br>

<strong style="font-family: Lato-Light;color:484848">For B2C we recommend:</strong><br>

STP analysis<br>

Facebook promotions<br>

Twitter Promotions<br>
...
?>
                    ...
                    <div class="col-md-3 portfolio-item" style="width:20%;height:30%">
                        <dl>
                          <dt>Bucket 1: Social Media Tools</dt>
                            <dd>
                                <table style="width:100%;margin-bottom:-5%">
<tr>Facebook - Promoted Posts</tr>
<tr>Twitter - Promoted Tweets</tr>
<tr>Instagram - Sponsored Ads</tr>
<tr>Linkedin – Promoted Updates</tr>
...
<dt>Bucket 2: Search Engine Tools</dt>
                            <dd>
                                <table style="width:100%;margin-bottom:-5%">
<tr>Google AdWords</tr>
<tr>Search Engine Optimisation</tr>
...
<dt>Bucket 3: Other Digital Marketing Tools</dt>
                            <dd>
                                <table style="width:100%;margin-bottom:-5%">
<tr>STP analysis</tr>
<tr>Theme based ads</tr>
<tr>Seasonal advertising</tr>
<tr>Email</tr>
